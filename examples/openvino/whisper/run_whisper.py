...
The encoder and cross-KV programs run once per utterance; the decoder runs once
per generated token. The additive attention mask is built host-side each step so
SDPA only attends to populated cache slots.
